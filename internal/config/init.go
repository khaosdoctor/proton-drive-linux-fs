...
var initFields = []struct {
	...
	{"mountpoint", "Where the drive is mounted. Defaults to ~/ProtonDrive; change it to any directory you own.", func(d Config) string { return strconv.Quote(d.Mountpoint) }},
